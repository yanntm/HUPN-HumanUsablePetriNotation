package fr.lip6.hupn.serialization;
...
public class SerializationUtil  {
	...
	private static Injector createInjector() {
		return Guice.createInjector(new HUPNRuntimeModule());
	}
	...
	public static void systemToFile(PetriNet system, String filename) throws IOException
	{
		if(! filename.endsWith(".hupn"))
		{
			java.lang.System.err.println("Warning: filename '" + filename + "' should end with .hupn extension ");
		}
...
//			java.lang.System.out.println("You can see result in file: " + filename);
	 ...
	 */
	public static PetriNet fileToPetriNet (String filename)
	{
		if(! filename.endsWith(".hupn"))
		{
			java.lang.System.err.println("Warning: filename '" + filename + "' should end with .hupn extension ");
		...
		PetriNet system = (PetriNet) res.getContents().get(0);
